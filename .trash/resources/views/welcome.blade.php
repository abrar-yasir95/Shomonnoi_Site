...
@section('content')
            ...
            <div class="row">
                <div class="col-md-8 ml-auto mr-auto">
                    <div class="brand">
                        ...
                        <p class="paragraph">The world has not seen such an alarming situation due to the Corona outbreak after World War II. Nearly all the countries have been affected by this devastating virus and Bangladesh is also no exception.
                            ...
                            Join this fight against the COVID-19 pandemic being a part of shomonnoibd.com.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="main main-raised">
        ...
        <iframe width="100%" height="500px" src="https://experience.arcgis.com/experience/714993bf09824fc28a4d8d46c6cdf212/" frameborder="0"></iframe>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-8 col-md-8">
                        <div class="causes_thumb">
                            ...
                            <div class="cause_info mt-1">
                                <div class="section_title">
                                    <div class="row no-gutters">
                                        <div class="col-md-6">
                                            <span class="alert-info text-center justify-content-center d-block text-dark font-weight-normal">Click the dots to see details</span>
                                        </div>
                                        <div class="col-md-6">
                                            <span class="alert-danger text-center justify-content-center d-block text-dark font-weight-normal">Source: IEDCR</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row align-items-lg-start" align="center">
                        ...
                        <div class="causes_thumb">
                            ...
                            <div class="cause_info mt-1">
                                <div class="section_title">
                                    <div class="row no-gutters">
                                        <div class="col-md-9">
                                            <span class="alert-danger text-center justify-content-center d-block text-dark font-weight-normal">Source: "Manus Manusher Jonnyo", "Pay it Forward" and in collaboration with "Ministry of Health"</span>
                                        </div>
                                        <div class="col-md-3">
                                            <span class="alert-info text-center justify-content-center d-block text-dark font-weight-normal">Click the dots to see details</span>
                                        </div>
                    ...
                    <div class="col-xl-4 col-md-4">
                        ...
                        <div class="blog_right_sidebar">
                                        ...
                                        <a href="{{$single_blog->link}}" target="_blank">
                                            <div class="card">
                                                <div class="card-header card-header-primary">
                                                    <h4 class="card-title">{{$single_blog->title}}</h4>
                                                </div>
                                                <div class="card-body">
                            ...
                            @endforelse
                            <a href="/news" class="btn btn-info" target="_blank">View All News</a>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-3">
                        <div class="help_info">
                            ...
                            <a href="{{asset('/organizations')}}" class="text-success" target="_blank">See All Organizations</a>
                        </div>
                    </div>
                    <div class="col-xl-9">
