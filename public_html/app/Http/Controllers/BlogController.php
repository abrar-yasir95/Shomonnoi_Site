...
//            $visitors = max($visitors, $analytics['visitors']);
        ...
        SEOMeta::setDescription(strip_tags($single_blog->description));
        SEOMeta::addMeta('article:published_time', $single_blog->created_at->toW3CString(), 'property');

        OpenGraph::setDescription(strip_tags($single_blog->description));
        ...
        JsonLd::setDescription(strip_tags($single_blog->description));
